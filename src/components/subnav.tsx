...
const links = [
  { href: "/", label: "Dashboard", icon: LayoutDashboard, exact: true, requiresAuth: false },
  { href: "/sprints", label: "Sprints", icon: Layers, exact: false, requiresAuth: false },
  { href: "/stories", label: "User Stories", icon: ListChecks, exact: false, requiresAuth: false },
  { href: "/peer-help", label: "Kennisdeling", icon: Users, exact: false, requiresAuth: false },
  { href: "/settings", label: "Instellingen", icon: Settings, exact: false, requiresAuth: false },
  { href: "/export", label: "Exporteren", icon: Upload, exact: false, requiresAuth: true },
];
...
export function MinorSubnav() {
  ...
  const visibleLinks = links.filter((l) => !l.requiresAuth || isAuthenticated);
